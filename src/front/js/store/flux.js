...
const baseURLApi = "https://3001-rose-constrictor-bxj6tiry.ws-us04.gitpod.io/api/";

const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			URLCodeQR: "https://3000-rose-constrictor-bxj6tiry.ws-us04.gitpod.io/person/infoqr/",
			QRCodePerson: [],
			PersonInfoQR: [],
			infoAPIExterna: [],
			message: null,
