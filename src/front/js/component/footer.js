	...
	<footer className="footer-class">
		<div className="footer-left col-md-4 col-sm-6">
			<p className="about">
				...
				Integer tellus est, vehicula eu lectus tincidunt, ultricies feugiat leo. Suspendisse tellus elit,
				pharetra in hendrerit ut, aliquam quis augue. Nam ut nibh mollis, tristique ante sed, viverra massa.
			</p>
			<div className="icons">
				<a href="#">
