...
Revision ID: a470f5f37d95
Revises: 
Create Date: 2021-05-21 22:47:26.464026
...
def upgrade():
    ...
    sa.Column('vaccine1_date', sa.Date(), nullable=True),
    sa.Column('vaccine2_date', sa.Date(), nullable=True),
