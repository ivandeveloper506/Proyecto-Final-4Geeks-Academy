...
const baseURLApi = "https://3001-apricot-cricket-v7ur75w0.ws-us04.gitpod.io/api/";

const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			URLCodeQR: "https://3000-apricot-cricket-v7ur75w0.ws-us04.gitpod.io/person/infoqr/",
			QRCodePerson: [],
			PersonInfoQR: [],
			infoAPIExterna: [],
			message: null,
